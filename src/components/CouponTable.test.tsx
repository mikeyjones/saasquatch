...
import { CouponTable, type Coupon } from './CouponTable'
...
describe('CouponTable', () => {
	...
	describe('Render Behavior', () => {
		it('should render table with coupons', () => {
			...
			render(
				<CouponTable coupons={coupons} onEdit={mockOnEdit} onDelete={mockOnDelete} />
			)
		...
		it('should render empty state when no coupons', () => {
			render(
				<CouponTable coupons={[]} onEdit={mockOnEdit} onDelete={mockOnDelete} />
			)
