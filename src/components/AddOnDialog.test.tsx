...
describe('AddOnDialog', () => {
	...
	describe('Render Behavior', () => {
		it('should render dialog when open', () => {
			...
			expect(screen.getByRole('heading', { name: /add-on/i })).toBeInTheDocument()
		})
		...
		it('should show create title in create mode', () => {
			...
			expect(screen.getByRole('heading', { name: /create new add-on/i })).toBeInTheDocument()
		})
		...
		it('should show edit title in edit mode', () => {
			...
			expect(screen.getByRole('heading', { name: /edit add-on/i })).toBeInTheDocument()
		})
	})
	...
	describe('Form Submission', () => {
		it('should call API to create add-on', async () => {
			...
			mockFetch().mockResolvedValueOnce(mockFetchSuccess({ addOn: { id: 'addon-1' } }))
