 ...
 */
export function ProductSubscriptionsCard({
	subscriptions,
}: ProductSubscriptionsCardProps) {
	...
	return (
		<div className="space-y-6">
			{Array.from(subscriptionsByProduct.entries()).map(
				([productName, productSubscriptions]) => (
					<div
						...
						<div className="bg-muted/50 px-6 py-4 border-b">
							<div className="flex items-center justify-between">
								...
								<div className="text-sm text-muted-foreground">
									{productSubscriptions.length} subscription
									{productSubscriptions.length !== 1 ? "s" : ""}
								</div>
							</div>
						</div>
									...
									<div className="flex items-start justify-between mb-4">
										<div className="flex-1">
											<div className="flex items-center gap-3 mb-2">
												...
												<span
													className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusColor(subscription.status)}`}
												>
