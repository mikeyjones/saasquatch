					...
					<div>
						<div className="flex items-center gap-3 mb-2">
							...
							{customer.subscriptionStatus && (
								<span
									className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(customer.subscriptionStatus)}`}
								>
									{customer.subscriptionStatus}
								</span>
							)}
							<span
								className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase ${getImportanceColor(customer.importance)}`}
							>
