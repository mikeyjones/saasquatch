...
describe("CreateDealDialog", () => {
	...
	describe("Render Behavior", () => {
		it("should render dialog when open", async () => {
			...
			expect(
				screen.getByRole("heading", { name: /create new deal/i }),
			).toBeInTheDocument();
		});
		...
		it("should not render dialog when closed", () => {
			...
			expect(
				screen.queryByRole("heading", { name: /create new deal/i }),
		...
		it("should show dialog description", async () => {
			...
			expect(
				screen.getByText(/add a new deal to your sales pipeline/i),
			).toBeInTheDocument();
		});
	});
	...
	describe("Organization Search", () => {
		it("should render organization search input", async () => {
			...
			await waitFor(() => {
				expect(
					screen.getByPlaceholderText(/search for organization/i),
				).toBeInTheDocument();
			});
		});
		...
		it("should filter organizations when typing in search", async () => {
			...
			mockFetch().mockResolvedValueOnce(
				mockFetchSuccess({ pipelines: mockPipelines }),
			);
