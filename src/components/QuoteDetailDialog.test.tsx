...
describe("QuoteDetailDialog", () => {
	describe("Render Behavior", () => {
		it("should not render when quote is null", () => {
			render(
				<QuoteDetailDialog open={true} onOpenChange={() => {}} quote={null} />,
			);
	...
	describe("Action Buttons", () => {
		it("should show Send button for draft quotes", () => {
			...
			expect(
				screen.getByRole("button", { name: /send quote/i }),
			).toBeInTheDocument();
		});
		...
		it("should show Accept and Reject buttons for sent quotes", () => {
			...
			expect(
				screen.getByRole("button", { name: /accept.*convert/i }),
			).toBeInTheDocument();
			expect(
