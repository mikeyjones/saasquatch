    ...
    <div>
      ...
      <Input
        ...
        onChange={(e) => {
          ...
          console.log('NumberField onChange - input:', inputValue, 'current field value:', field.state.value)
          ...
          if (inputValue === '' || inputValue === null || inputValue === undefined) {
            ...
            if (!Number.isNaN(numValue)) {
              ...
              console.log('NumberField after handleChange - new value:', field.state.value)
            } else {
