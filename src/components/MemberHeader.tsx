import { Building2, Mail, Phone, Briefcase, Shield, Ban, CheckCircle, Key } from 'lucide-react'
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className={member.status === 'suspended' ? 'text-green-600 hover:text-green-700' : 'text-red-600 hover:text-red-700'}
          >
