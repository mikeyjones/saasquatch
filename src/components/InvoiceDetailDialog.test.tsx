...
const mockInvoice: Invoice = {
	...
	paidAt: null,
	lineItems: [
		{ description: 'Pro Plan Subscription', quantity: 1, unitPrice: 10000, total: 10000 },
	],
...
describe('InvoiceDetailDialog', () => {
	...
	describe('Totals', () => {
		it('should display subtotal formatted as currency', () => {
			...
			expect(screen.getAllByText(/\$100\.00/).length + screen.getAllByText(/\$110\.00/).length).toBeGreaterThan(0)
		})
	...
	describe('Action Buttons', () => {
		...
		it('should render Mark as Paid button for draft invoices', () => {
			render(
				<InvoiceDetailDialog
					open={true}
					onOpenChange={mockOnOpenChange}
		...
		it('should not render Mark as Paid button for paid invoices', () => {
			const paidInvoice: Invoice = { ...mockInvoice, status: 'paid', paidAt: '2024-01-20' }
			render(
				<InvoiceDetailDialog
					open={true}
					onOpenChange={mockOnOpenChange}
