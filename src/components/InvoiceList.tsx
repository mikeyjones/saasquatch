								...
								<div className="flex items-start justify-between">
									<div>
										...
										<Link
											...
											params={{
												tenant: tenant || "",
												customerId: invoice.tenantOrganization.slug,
											}}
											className="text-sm text-gray-500 mt-1 hover:text-indigo-600 hover:underline block"
										>
											{invoice.tenantOrganization.name}
										</Link>
									</div>
									<span
							...
							<div className="hidden md:grid md:grid-cols-12 gap-4 items-center">
								...
								<div className="col-span-3">
									<Link
										...
										className="font-medium text-gray-900 truncate hover:text-indigo-600 hover:underline block"
									>
										{invoice.tenantOrganization.name}
									</Link>
									{invoice.subscription && (
