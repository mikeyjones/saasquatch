...
describe('CRMActivityTimeline', () => {
	describe('Render Behavior', () => {
		...
		it('should render activities list', () => {
			...
			expect(screen.getByText(/created deal "enterprise contract"/i)).toBeInTheDocument()
			expect(screen.getByText(/won deal "enterprise contract"/i)).toBeInTheDocument()
			expect(screen.getByText(/added contact "bob wilson"/i)).toBeInTheDocument()
		})
	...
	describe('Activity Icons', () => {
		it('should render different icons for different activity types', () => {
			...
			const activityItems = screen.getAllByText(/./i).filter((el) =>
				el.classList.contains('text-sm') && el.classList.contains('text-gray-900')
			)
	...
	describe('Timeline Structure', () => {
		...
		it('should render activities in provided order', () => {
			...
			const descriptions = screen.getAllByText(/./i).filter((el) =>
