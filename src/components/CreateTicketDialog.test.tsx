...
describe('CreateTicketDialog', () => {
	...
	describe('Render Behavior', () => {
		...
		it('should show dialog description', async () => {
			...
			expect(screen.getByText(/create a support ticket for a customer/i)).toBeInTheDocument()
		})
	})
	...
	describe('Customer Search', () => {
		it('should render customer search input', async () => {
			...
			await waitFor(() => {
				expect(screen.getByPlaceholderText(/fuzzy search by name/i)).toBeInTheDocument()
			})
		})
		...
		it('should filter members when typing in search', async () => {
			...
			await waitFor(() => {
				...
				const customerButton = buttons.find(button => {
					...
					return text.includes('john doe') && !text.includes('cancel') && !text.includes('create')
				})
	...
	describe('Validation', () => {
		it('should prevent submission when no customer selected', async () => {
			...
			await user.type(screen.getByLabelText(/initial message/i), 'Test message')
	...
	describe('Form Submission', () => {
		it('should call createTicket when form is submitted', async () => {
			...
			await waitFor(() => {
				expect(ticketsData.createTicket).toHaveBeenCalledWith('acme', expect.objectContaining({
					title: 'Test Ticket',
					priority: 'normal',
	...
	describe('Loading States', () => {
		it('should show loading state while fetching members', async () => {
			vi.mocked(membersData.fetchMembers).mockImplementation(() => new Promise(() => {})) // Never resolves
