...
export function CreateCustomerDialog({
	...
	const [loadedCustomer, setLoadedCustomer] = useState<CustomerData | null>(
		null,
	);
			...
			<DialogContent className="sm:max-w-[560px] max-h-[90vh] overflow-y-auto">
				...
				>
					...
					<form.AppField name="billingAddress">
						{(field) => <field.TextArea label="Billing Address" rows={2} />}
					</form.AppField>
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setSelectedAssignee(value === "unassigned" ? "" : value)
							}
						>
							<SelectTrigger>
					...
					<form.AppField name="notes">
						{(field) => <field.TextArea label="Notes" rows={2} />}
					</form.AppField>
