...
describe("OrganizationCustomProperties", () => {
	...
	describe("Render Behavior", () => {
		it("should render empty state when no properties", () => {
			render(
				<OrganizationCustomProperties metadata={{}} onUpdate={mockOnUpdate} />,
			);
	...
	describe("Edit Mode", () => {
		it("should render Edit Properties button", () => {
			...
			expect(
				screen.getByRole("button", { name: /edit properties/i }),
			).toBeInTheDocument();
		});
	...
	describe("Removing Properties", () => {
		it("should remove property when delete button is clicked", async () => {
			...
			const deleteButtons = screen
				.getAllByRole("button")
				.filter((btn) => btn.classList.contains("text-destructive"));
