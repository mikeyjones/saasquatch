...
import { ProductTierCard, type ProductTier } from './ProductTierCard'
...
const mockTier: ProductTier = {
	...
	features: ['Unlimited users', '24/7 Support', 'API Access', 'Custom integrations'],
}
...
describe('ProductTierCard', () => {
	...
	describe('Action Buttons', () => {
		...
		it('should render Delete button', () => {
			const { container } = render(<ProductTierCard tier={mockTier} onDelete={mockOnDelete} />)

			// Delete button is icon-only
			const deleteButton = container.querySelector('button[class*="hover:text-red-500"]')
