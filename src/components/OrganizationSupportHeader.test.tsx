...
describe('OrganizationSupportHeader', () => {
	...
	describe('Status Badge', () => {
		...
		it('should render trialing status badge', () => {
			const trialingOrg = { ...mockOrganization, subscriptionStatus: 'trialing' }
		...
		it('should render canceled status badge', () => {
			const canceledOrg = { ...mockOrganization, subscriptionStatus: 'canceled' }
		...
		it('should render past_due status badge with space', () => {
			const pastDueOrg = { ...mockOrganization, subscriptionStatus: 'past_due' }
	...
	describe('Action Buttons', () => {
		...
		it('should render Contact Customer button when callback provided', () => {
			...
			expect(screen.getByRole('button', { name: /contact customer/i })).toBeInTheDocument()
		})
		...
		it('should call onContactCustomer when Contact Customer is clicked', async () => {
			...
			await user.click(screen.getByRole('button', { name: /contact customer/i }))
