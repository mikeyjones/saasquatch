...
describe('SubscriptionCard', () => {
	...
	describe('Render Behavior', () => {
		...
		it('should display draft status with banner', () => {
			const draftSubscription = { ...mockSubscription, status: 'draft' as const }
		...
		it('should display different statuses', () => {
			const trialSubscription = { ...mockSubscription, status: 'trial' as const }
	...
	describe('User Interactions', () => {
		it('should call onViewUsage when view usage button is clicked', async () => {
			...
			const viewUsageButton = screen.getByRole('button', { name: /view usage/i })
		...
		it('should call onModifyPlan when modify plan button is clicked', async () => {
			...
			const modifyPlanButton = screen.getByRole('button', { name: /modify plan/i })
