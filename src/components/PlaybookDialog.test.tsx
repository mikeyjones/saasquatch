...
describe("PlaybookDialog", () => {
	...
	describe("Render Behavior", () => {
		it("should render dialog when open", () => {
			...
			expect(
				screen.getByRole("heading", { name: /playbook/i }),
			).toBeInTheDocument();
		});
		...
		it("should show create title in create mode", () => {
			...
			expect(
				screen.getByRole("heading", { name: /create new playbook/i }),
			).toBeInTheDocument();
		});
		...
		it("should show edit title in edit mode", () => {
			...
			expect(
				screen.getByRole("heading", { name: /edit playbook/i }),
			).toBeInTheDocument();
		});
	});
	...
	describe("Form Submission", () => {
		it("should call createPlaybook when form is submitted", async () => {
			...
			await waitFor(() => {
				expect(knowledgeData.createPlaybook).toHaveBeenCalledWith(
					"acme",
					expect.any(Object),
				);
			});
