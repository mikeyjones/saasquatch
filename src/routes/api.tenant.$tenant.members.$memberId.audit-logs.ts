...
import { db } from '@/db'
import { auditLog, organization, tenantUser, tenantOrganization } from '@/db/schema'
import { eq, and, desc } from 'drizzle-orm'
import { auth } from '@/lib/auth'

export const Route = createFileRoute('/api/tenant/$tenant/members/$memberId/audit-logs')({
  server: {
    handlers: {
      /**
