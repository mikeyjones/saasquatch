...
describe("Ticket Messages API endpoint", () => {
	describe("POST /:tenant/api/tickets/:ticketId", () => {
		describe("Authentication and Authorization", () => {
			...
			it("should verify user is a member of the organization", () => {
				const authorizationCheck = {
					check:
						"member.organizationId === org.id AND member.userId === session.user.id",
			...
			it("should verify ticket belongs to the organization", () => {
				const securityCheck = {
					...
					prevention:
						"Cannot post messages to tickets from other organizations",
				};
		...
		describe("Security and Scoping", () => {
			...
			it("should verify user membership before allowing message creation", () => {
				...
				const messageCreationIndex =
					securityCheck.order.indexOf("create message");
