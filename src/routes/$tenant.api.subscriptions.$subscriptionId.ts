...
export const Route = createFileRoute(
	...
	server: {
		handlers: {
			/**
			 * GET /:tenant/api/subscriptions/:subscriptionId
			...
			GET: async ({ request, params }) => {
				try {
					...
					const addOns = await db
						...
						.innerJoin(
							productAddOn,
							eq(subscriptionAddOn.productAddOnId, productAddOn.id),
						)
					...
					const activities = await db
						...
						.where(
							eq(subscriptionActivity.subscriptionId, params.subscriptionId),
						)
			...
			/**
			 * PUT /:tenant/api/subscriptions/:subscriptionId
			...
			/**
			 * DELETE /:tenant/api/subscriptions/:subscriptionId
