 ...
 * - GET /:tenant/api/quotes - List all quotes with optional filters
 * - POST /:tenant/api/quotes - Create a new quote
 *
...
export const Route = createFileRoute("/$tenant/api/quotes")({
	server: {
		handlers: {
			/**
			 * GET /:tenant/api/quotes
