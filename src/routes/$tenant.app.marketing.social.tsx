...
import { Calendar, Linkedin, Twitter, Clock } from "lucide-react";
...
const mockPosts: SocialPost[] = [
	{
		...
		title: "LinkedIn Post",
		content:
			"Excited to announce our new Q4 features! Check out the blog post below.",
		status: "scheduled",
	...
	},
	{
		...
		title: "Twitter Post",
		content:
			"Downtime resolved! Thanks for your patience everyone. #SaaS #Update",
		status: "posted",
	...
	},
	{
		...
		title: "LinkedIn Post",
		content:
			"We're hiring! Join our growing team and help shape the future of SaaS.",
		status: "scheduled",
	...
	},
	{
		...
		title: "Twitter Post",
		content:
			"New case study: How Acme Corp increased revenue by 40% using our platform 🚀",
		status: "posted",
...
const platformConfig: Record<
	Platform,
	{ icon: typeof Linkedin; bgColor: string; iconColor: string }
> = {
	linkedin: {
		icon: Linkedin,
		bgColor: "bg-blue-100",
