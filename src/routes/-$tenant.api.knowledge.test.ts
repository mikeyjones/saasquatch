 ...
 *
 * Endpoints tested:
 * - GET /:tenant/api/knowledge/search
 * - GET /:tenant/api/knowledge/articles
 * - POST /:tenant/api/knowledge/articles
 * - PUT /:tenant/api/knowledge/articles
 * - DELETE /:tenant/api/knowledge/articles
...
describe("Knowledge Search API", () => {
	describe("GET /:tenant/api/knowledge/search", () => {
...
describe("Knowledge Articles API", () => {
	describe("GET /:tenant/api/knowledge/articles", () => {
		it("should require authentication", () => {
			const expectedResponse = {
				error: "Unauthorized",
				articles: [],
	...
	describe("POST /:tenant/api/knowledge/articles", () => {
	...
	describe("PUT /:tenant/api/knowledge/articles", () => {
	...
	describe("DELETE /:tenant/api/knowledge/articles", () => {
		it("should require article id in query params", () => {
			// DELETE /acme/api/knowledge/articles?id=art_123
...
describe("Playbooks API", () => {
	describe("GET /:tenant/api/knowledge/playbooks", () => {
		it("should require authentication", () => {
			const expectedResponse = {
				error: "Unauthorized",
				playbooks: [],
	...
	describe("POST /:tenant/api/knowledge/playbooks", () => {
	...
	describe("PUT /:tenant/api/knowledge/playbooks", () => {
	...
	describe("DELETE /:tenant/api/knowledge/playbooks", () => {
		it("should require playbook id in query params", () => {
			// DELETE /acme/api/knowledge/playbooks?id=pb_123
