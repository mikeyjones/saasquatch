...
export const Route = createFileRoute('/api/tenant/$tenant/crm/contacts/$contactId')({
  server: {
    handlers: {
      /**
       * GET /api/tenant/:tenant/crm/contacts/:contactId
      ...
      /**
       * PUT /api/tenant/:tenant/crm/contacts/:contactId
      ...
      /**
       * DELETE /api/tenant/:tenant/crm/contacts/:contactId
       * Delete a contact
       */
