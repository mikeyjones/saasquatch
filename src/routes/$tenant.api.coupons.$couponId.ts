...
export const Route = createFileRoute("/$tenant/api/coupons/$couponId")({
	server: {
		handlers: {
			/**
			 * GET /:tenant/api/coupons/:couponId
			...
			/**
			 * PUT /:tenant/api/coupons/:couponId
			 * Update a coupon
							...
							const plans = await db
								...
								.where(
									and(
										...
										or(
											...applicablePlanIds.map((id) => eq(productPlan.id, id)),
										),
									),
								);
			...
			/**
			 * DELETE /:tenant/api/coupons/:couponId
