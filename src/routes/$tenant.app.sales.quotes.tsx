...
function QuotesPage() {
	...
	const { data, isLoading, error, refetch } = useQuery<QuotesResponse>({
	...
	return (
		<main className="flex-1 overflow-auto p-6">
			...
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
				...
				<div className="flex items-center gap-2 sm:gap-3">
					...
					<Button
						...
						size="sm"
						className="sm:h-10 flex-1 sm:flex-initial"
					>
			...
			<QuoteList
				...
				onDownloadPDF={handleDownloadPDF}
				isSending={
					sendQuoteMutation.isPending ? sendQuoteMutation.variables : null
				}
			/>
