      ...
      try {
        ...
        if (session?.session) {
          ...
          if (membershipResult.isMember) {
            ...
            setError('You are not a member of this organization. Please sign in with an account that has access.')
          }
        }
      } catch {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!membershipResult.isMember) {
        ...
        setError(membershipResult.error || 'You are not a member of this organization')
        setLoading(false)
        return
      }
