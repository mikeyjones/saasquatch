          ...
          <tbody>
            {isLoading ? (
              ...
              filteredMembers.map((member) => (
                <MemberRow key={member.id} member={member} searchQuery={searchQuery} tenant={tenant} />
              ))
            )}
          </tbody>
        </table>
...
function MemberRow({ member, searchQuery, tenant }: { member: Member; searchQuery: string; tenant: string }) {
  const roleStyles = {
