...
describe("Products API", () => {
	describe("GET /:tenant/api/product-catalog/products", () => {
	...
	describe("POST /:tenant/api/product-catalog/products", () => {
		it("should require authentication", () => {
			const expectedResponse = { error: "Unauthorized" };
			expect(expectedResponse.error).toBe("Unauthorized");
		});
	...
	describe("PUT /:tenant/api/product-catalog/products", () => {
	...
	describe("DELETE /:tenant/api/product-catalog/products", () => {
