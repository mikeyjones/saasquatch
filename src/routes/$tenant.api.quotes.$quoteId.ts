 ...
 * - GET /:tenant/api/quotes/:quoteId - Get quote details
 * - PUT /:tenant/api/quotes/:quoteId - Update a draft quote
 * - DELETE /:tenant/api/quotes/:quoteId - Delete a draft quote
 *
...
export const Route = createFileRoute("/$tenant/api/quotes/$quoteId")({
	server: {
		handlers: {
			/**
			 * GET /:tenant/api/quotes/:quoteId
			...
			/**
			 * DELETE /:tenant/api/quotes/:quoteId
