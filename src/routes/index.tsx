	...
	const features = [
		{
			...
			title: "Forms",
			description:
				"Powerful form management with TanStack Form. Type-safe, performant, and developer-friendly.",
			link: "/forms",
		...
		},
		{
			...
			title: "Store",
			description:
				"Reactive state management with TanStack Store. Simple, fast, and scalable.",
			link: "/store",
		...
		},
		{
			...
			title: "Table",
			description:
				"Headless table UI with TanStack Table. Powerful filtering, sorting, and pagination.",
			link: "/table",
		...
		},
		{
			...
			title: "Database",
			description:
				"Type-safe database operations with Drizzle ORM. PostgreSQL integration included.",
			link: "/database",
		...
		},
		{
			...
			title: "MCP Todos",
			description:
				"Model Context Protocol integration. Real-time todos with server-sent events.",
			link: "/todos",
		...
		},
		{
			...
			description:
				"Full-stack framework with server functions, SSR, and type safety.",
			...
			<section className="relative py-20 px-6 text-center overflow-hidden">
				...
				<div className="relative max-w-5xl mx-auto">
					...
					<p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8">
						A full-stack application showcasing TanStack Router, Form, Store,
						Table, Query, and more. Built with TanStack Start for modern web
						applications.
					</p>
				</div>
			</section>
