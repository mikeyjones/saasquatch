...
export const Route = createFileRoute(
	...
	server: {
		handlers: {
			/**
			 * GET /:tenant/api/crm/customers/:customerId/contacts
			...
			/**
			 * POST /:tenant/api/crm/customers/:customerId/contacts
			...
			POST: async ({ request, params }) => {
				try {
					...
					const { name, email, phone, title, role, avatarUrl, notes, isOwner } =
						body as {
							name?: string;
							email?: string;
							phone?: string;
