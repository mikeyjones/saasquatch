...
describe('Knowledge Search Utilities', () => {
  describe('generateSlug', () => {
    ...
    it('should handle common article titles', () => {
      ...
      expect(generateSlug('Understanding Your Invoice')).toBe('understanding-your-invoice')
      expect(generateSlug('API Rate Limits Explained')).toBe('api-rate-limits-explained')
      expect(generateSlug('Managing Team Members')).toBe('managing-team-members')
      expect(generateSlug('Webhook Configuration Guide')).toBe('webhook-configuration-guide')
    })
  })
})
