...
describe('knowledge data functions', () => {
	...
	describe('fetchArticles', () => {
		...
		it('should return articles array on success', async () => {
			...
			mockFetch().mockResolvedValueOnce(mockFetchSuccess({ articles: mockArticles }))
	...
	describe('createArticle', () => {
		it('should make POST request with article data', async () => {
			...
			mockFetch().mockResolvedValueOnce(mockFetchSuccess({ article: mockArticle }))
	...
	describe('deleteArticle', () => {
		it('should make DELETE request with article ID', async () => {
			...
			expect(fetch).toHaveBeenCalledWith(
				expect.stringContaining('/api/tenant/acme/knowledge/articles?id=article-1'),
				expect.objectContaining({
					method: 'DELETE',
				})
			)
	...
	describe('createPlaybook', () => {
		it('should make POST request with playbook data', async () => {
			...
			mockFetch().mockResolvedValueOnce(mockFetchSuccess({ playbook: mockPlaybook }))
